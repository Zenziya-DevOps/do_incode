...
export class COMP_Footer extends Component {
  render() {
    return (
      <>
        <div style={{ backgroundColor: colors[8] }} className="pt-s5">
              ...
              <>
                <Row className="pt-5 pb-5">
                  <Col xs={0} className="text-center my-auto">
                    <a href="/.">
                      <img
                        src={`${PRD.assets}efectivoya__.svg`}
                ...
                <Row className="text-center mt-4">
                  ...
                  <Col xs={2}>
                    {' '}
                    <a href={`${PRD.land}Consentimiento`}>
                      {' '}
              ...
              <>
                <Row>
                  <Col xs={12} className="p-5">
                    <a href="/.">
                      <img
                        src={`${PRD.assets}efectivoya_.svg`}
                        className="img img-fluid"
                      />
                    </a>
                  </Col>
